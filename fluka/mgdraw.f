...
*                                                                      *
      ...
      WRITE(LUNOUT,*), 'PH: BXDRAW INITIALIZATION'
          ...
          WRITE(*,*), 'PH: call BXDRAW'

*         in LATTICE: from vacuum to jaw
          IF(MREG.EQ.240.AND.NEWREG.EQ.242) THEN
                   write(67,*) 
     &    IJ,JTRACK,ncase,IZ,IA,etrack,XSCO,ZSCO
          ENDIF
*         in LATTICE: from jaw to vacuum
          IF(MREG.EQ.242.AND.NEWREG.EQ.240) THEN
                   write(68,*) 
     &           JTRACK,ncase,AA,IZ,IA,etrack,XSCO,YSCO,ZSCO  
          ENDIF

*         between a LATTICE and vacuum around jaws:
          IF(MREG.EQ.340.AND.NEWREG.EQ.242) THEN
                   write(69,*) 
     &           JTRACK,ncase,AA,IZ,IA,etrack,XSCO,YSCO,ZSCO 
          ENDIF
*         between vacuum around jaws and a LATTICE:
          IF(MREG.EQ.242.AND.NEWREG.EQ.340) THEN
                   write(70,*) 
     &           JTRACK,ncase,AA,IZ,IA,etrack,XSCO,YSCO,ZSCO  
          ENDIF
*
*IF(MREG.EQ.1394.AND.NEWREG.EQ.242) THEN
*         write(69,*) 
*       JTRACK,ncase,AA,IZ,IA,etrack,XSCO,YSCO  
*ENDIF
*
*IF(MREG.EQ.242.AND.NEWREG.EQ.1394) THEN
*         write(69,*) 
*       JTRACK,ncase,AA,IZ,IA,etrack,XSCO,YSCO  
*ENDIF
*
